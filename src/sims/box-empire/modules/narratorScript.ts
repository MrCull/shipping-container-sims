...
//   setSpeed3x         - set game speed to 3x
//   setSpeed5x         - set game speed to 5x
//
...
//   first gate-out revenue transaction       -> 'first-gate-out-money'
